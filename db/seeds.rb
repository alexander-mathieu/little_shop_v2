...
order_2 = Order.create!(user: buyer_2, status: 1, created_at: 3.days.ago, updated_at: 1.days.ago)
...
order_7 = Order.create!(user: buyer_2, status: 3, created_at: 9.days.ago, updated_at: 1.days.ago)
