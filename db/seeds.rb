...
order_1 = Order.create!(user: buyer_1, status: 2)
order_2 = Order.create!(user: buyer_2, status: 2)
order_3 = Order.create!(user: buyer_3, status: 2)
order_4 = Order.create!(user: buyer_4, status: 2)
order_5 = Order.create!(user: buyer_5, status: 2)
order_6 = Order.create!(user: buyer_1, status: 2)
order_7 = Order.create!(user: buyer_2, status: 2)

order_item_1 = OrderItem.create!(item: max, order: order_1, quantity: 12, price: max.price, fulfilled: true)
