...
order_4 = Order.create!(user: buyer_4, status: 2, created_at: 9.days.ago, updated_at: 1.days.ago)
order_5 = Order.create!(user: buyer_5, status: 0)
order_6 = Order.create!(user: buyer_1, status: 2, created_at: 5.days.ago, updated_at: 1.days.ago)
order_7 = Order.create!(user: buyer_2, status: 3)
order_8 = Order.create!(user: buyer_3, status: 0)
order_9 = Order.create!(user: buyer_4, status: 2, created_at: 2.days.ago, updated_at: 1.days.ago)
order_10 = Order.create!(user: buyer_5, status: 2, created_at: 4.days.ago, updated_at: 1.days.ago)
order_11 = Order.create!(user: buyer_1, status: 2, created_at: 4.days.ago, updated_at: 1.days.ago)
order_12 = Order.create!(user: buyer_2, status: 2, created_at: 2.days.ago, updated_at: 1.days.ago)
order_13 = Order.create!(user: buyer_3, status: 2, created_at: 2.days.ago, updated_at: 1.days.ago)
order_14 = Order.create!(user: buyer_4, status: 2, created_at: 6.days.ago, updated_at: 1.days.ago)
order_15 = Order.create!(user: buyer_5, status: 2, created_at: 3.days.ago, updated_at: 1.days.ago)
order_16 = Order.create!(user: buyer_3, status: 2, created_at: 9.days.ago, updated_at: 1.days.ago)
order_17 = Order.create!(user: buyer_3, status: 2, created_at: 6.days.ago, updated_at: 1.days.ago)
order_18 = Order.create!(user: buyer_3, status: 2, created_at: 4.days.ago, updated_at: 1.days.ago)
order_19 = Order.create!(user: buyer_2, status: 2, created_at: 7.days.ago, updated_at: 1.days.ago)
order_20 = Order.create!(user: buyer_2, status: 2, created_at: 3.days.ago, updated_at: 1.days.ago)
...
order_item_26 = OrderItem.create!(item: max, order: order_8, quantity: 1, price: max.price, fulfilled: true)
order_item_27 = OrderItem.create!(item: max, order: order_9, quantity: 1, price: max.price, fulfilled: true)
order_item_28 = OrderItem.create!(item: mike, order: order_10, quantity: 1, price: mike.price, fulfilled: true)
order_item_29 = OrderItem.create!(item: mike, order: order_11, quantity: 1, price: mike.price, fulfilled: true)
order_item_30 = OrderItem.create!(item: clayton, order: order_12, quantity: 1, price: clayton.price, fulfilled: true)
order_item_31 = OrderItem.create!(item: clayton, order: order_13, quantity: 1, price: clayton.price, fulfilled: true)
order_item_32 = OrderItem.create!(item: nolan, order: order_14, quantity: 1, price: nolan.price, fulfilled: true)
order_item_33 = OrderItem.create!(item: nolan, order: order_15, quantity: 1, price: nolan.price, fulfilled: true)
order_item_34 = OrderItem.create!(item: derek, order: order_16, quantity: 1, price: derek.price, fulfilled: true)
order_item_35 = OrderItem.create!(item: tony, order: order_17, quantity: 1, price: tony.price, fulfilled: true)
order_item_36 = OrderItem.create!(item: cal, order: order_18, quantity: 1, price: cal.price, fulfilled: true)
order_item_37 = OrderItem.create!(item: ken, order: order_19, quantity: 1, price: ken.price, fulfilled: true)
order_item_38 = OrderItem.create!(item: ryan, order: order_20, quantity: 1, price: ryan.price, fulfilled: true)
