...
RSpec.describe "as a user" do
  describe "when I visit /items" do
    before :each do
      ...
      @user_2 = User.create!(email: "user_2@gmail.com", role: 2, name: "User 2", address: "User 2 Address", city: "User 1 City", state: "User 1 State", zip: "22345", password: "12f456")
      @user_3 = User.create!(email: "user_3@gmail.com", role: 2, name: "User 3", address: "User 3 Address", city: "User 1 City", state: "User 1 State", zip: "32345", password: "122456")
      @user_4 = User.create!(email: "user_4@gmail.com", role: 2, name: "User 4", address: "User 4 Address", city: "User 1 City", state: "User 1 State", zip: "42345", password: "123256")
