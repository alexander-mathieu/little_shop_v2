...
RSpec.describe "as a user" do
  describe "when I visit /items" do
    before :each do
      ...
      @item_2 = @user_2.items.create!(name: "Item 2", price: 2.00, description: "Item 2 Description", image: "https://tradersofafrica.com/img/no-product-photo.jpg", inventory: 15)
      @item_3 = @user_2.items.create!(name: "Item 3", price: 3.00, description: "Item 3 Description", image: "https://tradersofafrica.com/img/no-product-photo.jpg", inventory: 20)
      @item_4 = @user_3.items.create!(name: "Item 4", price: 4.00, description: "Item 4 Description", image: "https://tradersofafrica.com/img/no-product-photo.jpg", inventory: 25)
      @item_5 = @user_3.items.create!(name: "Item 5", price: 5.00, description: "Item 5 Description", image: "https://tradersofafrica.com/img/no-product-photo.jpg", inventory: 30)
      @item_6 = @user_3.items.create!(name: "Item 6", price: 6.00, description: "Item 6 Description", image: "https://tradersofafrica.com/img/no-product-photo.jpg", inventory: 35)
    ...
    it "I see the top 5 most popular items by quantity purchased with quantity bought"
