...
describe "as a user" do
  describe "when I visit my profile page" do
    before :each do
        @user_1 = User.create!(email: "bob@bob.com", password: "123444", name: "bob", address:"123 bob st.", city: "bobton", state:"MA", zip: 28234)
    end
    ...
    #     expect(page).to have_content("georgeville")
    #     expect(page).to have_content("George")
    #     expect(page).to have_content("georgeville")
    #
    # end
