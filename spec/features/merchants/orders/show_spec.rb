...
describe "as a merchant" do
  describe "when I visit an order show from my dashboard" do
    before :each do
      ...
      @item_2 = @merchant_1.items.create!(name: "Item 2", active: true, price: 2.00, description: "Item Description", image: "https://tradersofafrica.com/img/no-product-photo.jpg", inventory: 10)
